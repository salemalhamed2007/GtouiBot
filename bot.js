...
client.on('message',async message => {
  ...
  client.on('message', Duy0 => {
    if (Duy0.content.startsWith('-bot-b')) {
  ...
  client.on('message', Duy0 => {
    if (Duy0.content.startsWith('@GtouiBot#4061')) {
        Duy0.channel.send(':white_check_mark: **Hi im @GtouiBot#4061 ** **|** ***My Prefix here is*** **|** **`-`**:thumbsup:**..**')
    }
}); 
